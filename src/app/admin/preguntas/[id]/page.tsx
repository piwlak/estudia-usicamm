...
export default function EditarPreguntaPage() {
  ...
  const [form, setForm] = useState<PreguntaForm>({
    ...
    const fetchPregunta = async () => {
      ...
      if (data) {
        setForm({
          ...
          opciones: data.opciones as string[],
          respuesta: data.respuesta as number,
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        <p className="text-slate-500">Cargando pregunta...</p>
      </div>
    );
  }
